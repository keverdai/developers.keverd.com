                ...
                <div className="space-y-4">
                  <div className="bg-white/50 rounded-xl p-4 border border-gray-200">
                    ...
                    <div className="mt-3 space-y-1">
                      ...
                      <p className="text-xs text-gray-600"><strong>Throws:</strong> <code className="bg-white/50 px-1 rounded border border-gray-200">IllegalArgumentException</code> if <code className="bg-white/50 px-1 rounded border border-gray-200">apiBaseUrl</code> does not start with "https://"</p>
                    </div>
                  </div>
                    ...
                    <table className="min-w-full text-sm">
                      ...
                      <tbody>
                        <tr className="border-b border-gray-200">
                          <td className="py-3 px-4 font-mono text-sm text-keverd-ink">apiBaseUrl</td>
          ...
          <section id="best-practices" className="mb-10 pb-10 border-b border-gray-200">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/50 rounded-xl p-4 border border-gray-200">
                ...
                <ul className="text-sm text-gray-700 space-y-1 list-disc ml-4">
                  <li>Always use HTTPS for API endpoints (enforced by the SDK)</li>
